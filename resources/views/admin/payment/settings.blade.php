 ...
 -->                       
            ...
            <div class="form-group row">
                            ...
                            <div class="col-xs-8"> 
                                ...
                                <option @if(Setting::get('currency') == "PHP") selected @endif value="PHP">Philippine peso (PHP)</option>
                                <!-- <option @if(Setting::get('currency') == "TZS") selected @endif value="TZS">Tanzanian Shilling (TZS)</option>
                                 <option @if(Setting::get('currency') == "R") selected @endif value="R">South Africa (ZAR)</option>
                                    <option @if(Setting::get('currency') == "$") selected @endif value="$">US Dollar (Equatorial Guinea currencyUSD)</option>
