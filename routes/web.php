...
Route::get('/timezone', function () {
  // Get the current timezone from config or directly from Carbon
  $timezone = config('app.timezone'); // This gets the timezone from the Laravel configuration
  $currentTime = Carbon::now()->toDateTimeString(); // Current time in the default timezone

  return "The configured timezone is: $timezone, and the current time is: $currentTime";
});
